...
<body>
    <div class="container">
    <div class="row">
    <span class="h2 text-align-center"> LISTE DES ENTREPRISES  </span>
    <span class="mt-2">
        <a href="/NousLesFemmes/index.php?view=ajoutEntreprise" class="btn btn-danger">Ajouter une Entreprise</a>
    </span>
    <div class="row mt-4">
